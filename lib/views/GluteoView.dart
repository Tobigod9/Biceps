...
class GluteoView extends StatefulWidget {
  GluteoView({super.key});

  @override
  State<GluteoView> createState() => _GluteoViewState();
}

class _GluteoViewState extends State<GluteoView> {
  List<DocumentSnapshot> ejercicios = [];
  int dayOfWeek = DateTime.now().weekday;
  String nivelUsuario = '';
  String categoria = 'gluteo';
      ...
      body: Column(
        children: [
          if (nivelUsuario.isNotEmpty)
            Stack(
              children: <Widget>[
                Image.asset('assets/img/gluteoBackground.png'),
                Positioned.fill(
                  child: Container(
