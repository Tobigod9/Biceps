...
class PerderPesoView extends StatefulWidget {
  PerderPesoView({super.key});

  @override
  State<PerderPesoView> createState() => _PerderPesoViewState();
}

class _PerderPesoViewState extends State<PerderPesoView> {
  List<DocumentSnapshot> ejercicios = [];
  int dayOfWeek = DateTime.now().weekday;
  String nivelUsuario = '';
  String categoria = 'pierde peso';
      ...
      body: Column(
        children: [
          if (nivelUsuario.isNotEmpty)
            Stack(
              children: <Widget>[
                Image.asset('assets/img/perderpesoBackground.png'),
                Positioned.fill(
                  child: Container(
