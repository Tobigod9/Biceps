...
class PiernaView extends StatefulWidget {
  PiernaView({super.key});

  @override
  State<PiernaView> createState() => _PiernaViewState();
}

class _PiernaViewState extends State<PiernaView> {
  List<DocumentSnapshot> ejercicios = [];
  int dayOfWeek = DateTime.now().weekday;
  String nivelUsuario = '';
  String categoria = 'pierna';
      ...
      body: Column(
        children: [
          if (nivelUsuario.isNotEmpty)
            Stack(
              children: <Widget>[
                Image.asset('assets/img/piernaBackground.png'),
                Positioned.fill(
                  child: Container(
